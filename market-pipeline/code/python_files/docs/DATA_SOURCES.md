...
Master list of every upstream the platform pulls from. Re-run `source_registry.py` to refresh reachability (last checked **2026-07-28**). Distinct from `data_ledger.md` (on-disk assets); this is the SOURCES catalog — constantly referenced & updated. 🟢 official exchange/regulator · ⚪ third-party aggregator.
...
| CN | ⚪ [akshare (wraps SSE/SZSE)](https://akshare.akfamily.xyz/) | HTTP 429 | ak.stock_zh_a_hist | none | after 12:30 IST (China close) | A-shares |
...
| CN | ⚪ [akshare indicators](https://akshare.akfamily.xyz/) | HTTP 429 | ak.stock_financial_analysis_indicator | none | after 12:30 IST · sleep 0.3s/req | wraps SSE/SZSE/Eastmoney; EPS+ROE to 2015 (10y); the free deep-history path for CN |
